...
public class MainActivity extends AppCompatActivity {
    ...
    public ArrayList<File> readOnlyAudioSongs(File file)
    {
        ...
        for(File individualFile :allFiles)
        {
            ...
            {
                if(individualFile.getName().endsWith(".mp3")||individualFile.getName().endsWith(".aac")||individualFile.getName()
                        .endsWith(".wav")||individualFile.getName().endsWith(".wma")||individualFile.getName().endsWith(".amr")||individualFile.getName().endsWith(".m4a"))
                {
